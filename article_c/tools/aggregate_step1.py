...
from article_c.common.csv_io import STEP1_EXPECTED_METRICS, aggregate_results, atomic_write_csv
...
def _build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        ...
        help="Dossier des résultats Step1 (défaut: article_c/step1/results).",
    )
    return parser
