...
This package simply re-exports everything from :mod:`VERSION_4.launcher` while
...
_pkg_dir = os.path.join(os.path.dirname(__file__), "..", "VERSION_4", "launcher")
__path__.append(os.path.abspath(_pkg_dir))

# Re-export public symbols from the versioned package.
module = import_module("VERSION_4.launcher")
