"""Campagne de densité SNIR (stage 1).

Ce scénario simule plusieurs tailles de réseau en mode FLoRa avec trois
clusters QoS (10 %, 30 %, 60 %). Pour chaque cluster, il enregistre DER,
PDR, SNIR moyen/médian, collisions et débit, puis exporte les résultats
au format CSV dans ``data/der_density.csv``.
"""
...
OUTPUT_PATH = ROOT_DIR / "data" / "der_density.csv"
