"""Scénario SNIR pour LoRaFlexSim (interférence inter-SF + seuils γ_thr).

Exemples CLI (Windows 11, PowerShell) :
  # python final/scenarios/run_snir.py --cell-radius 2500 --nodes 1000
  # python final/scenarios/run_snir.py --cell-radius 2500 --nodes 1000 --config config.ini
  # python final/scenarios/run_snir.py --cell-radius 2500 --nodes 1000 --runs 10 --period 300 --duration 86400
...
def _parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Exécute des scénarios QoS/ADR en SNIR et exporte des CSV par cluster."
    )
    parser.add_argument(
        "--cell-radius",
        type=float,
